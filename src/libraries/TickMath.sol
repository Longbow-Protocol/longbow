...
///         sqrt(1.0001^tick) as fixed point Q64.96 numbers.
/// @dev Port of Uniswap v3-core `TickMath` to Solidity 0.8.x (bodies wrapped in
///      `unchecked`, since the original depends on wrapping arithmetic).
library TickMath {
    ...
    function getSqrtRatioAtTick(int24 tick) internal pure returns (uint160 sqrtPriceX96) {
        unchecked {
            ...
            // Downcast + round up: divide by 1<<32, rounding up, then Q128.128 -> Q128.96.
